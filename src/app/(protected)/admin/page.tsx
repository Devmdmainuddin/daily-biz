        ...
        <div className="flex items-start gap-6 flex-wrap">
          <div className="bg-white shadow-[0_4px_12px_-5px_rgba(0,0,0,0.4)] p-6 w-full max-w-sm rounded-lg overflow-hidden">
            ...
            <div className="mt-4">
              ...
              <p className="mt-2 text-sm text-gray-800">Total : 50 Blogs</p>
            </div>
          ...
          <div className="bg-white shadow-[0_4px_12px_-5px_rgba(0,0,0,0.4)] p-6 w-full max-w-sm rounded-lg overflow-hidden">
            ...
            <div className="mt-4">
              ...
              <p className="mt-2 text-sm text-gray-800">Total Reviews : 1000k</p>
            </div>
          ...
          <div className="bg-white shadow-[0_4px_12px_-5px_rgba(0,0,0,0.4)] p-6 w-full max-w-sm rounded-lg overflow-hidden">
            ...
            <div className="mt-4">
              ...
              <p className="mt-2 text-sm text-gray-800">Total Users : 2500k</p>
            </div>
