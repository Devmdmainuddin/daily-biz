...
export function MainNav() {
  return (
    <div className="flex flex-col items-start justify-start md:flex-row md:items-center md:justify-between flex-wrap gap-3   z-50">
      <NavigationMenu>
        <NavigationMenuList>
          <NavigationMenuItem>
          ...
          <NavigationMenuItem>
            <Link href="/about" legacyBehavior passHref>
              <NavigationMenuLink className="bg-0">About</NavigationMenuLink>
            </Link>
          </NavigationMenuItem>
        </NavigationMenuList>
      </NavigationMenu>
      <div className="flex items-center justify-between w-20"></div>
    </div>
  );
}
